...
let c = server_generic.make_server(transparent_server.transparent_server, e => e, socks_server.make_socks_client({path: "/home/sebastian/gitprojects/universal-relay/urelay.sock"}));
for (let i = 1; i < 4; i++) {
